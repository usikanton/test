    ...
    private static WebDriver initFirefoxDriver(Platform platform) {
        switch (platform) {
            case WINDOWS:
                osSuffix = "win32.exe";
                System
                    .setProperty(GECKO_DRIVER_PROPERTY,
                        "src\\main\\resources\\drivers\\geckodriver_win32.exe");
                break;
            case LINUX:
                osSuffix = "linux64";
                System
                    .setProperty(GECKO_DRIVER_PROPERTY, "src\\main\\resources\\drivers"
                        + "\\geckodriver_linux64");
                break;
            case MAC:
                osSuffix = "mac64";
        ...
        switch (platform) {
            case WINDOWS:
                ...
                System.setProperty(CHROME_DRIVER_PROPERTY,
                    "src\\main\\resources\\drivers\\chromedriver_win64.exe");
                break;
            case LINUX:
                osSuffix = "linux64";
                System.setProperty(CHROME_DRIVER_PROPERTY,
                    "src\\main\\resources\\drivers\\chromedriver_linux64");
                break;
            case MAC:
                osSuffix = "mac64";
                System.setProperty(CHROME_DRIVER_PROPERTY,
                    "src\\main\\resources\\drivers\\chromedriver_mac64");
                break;
        }
